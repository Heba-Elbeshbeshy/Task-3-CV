...
def main():
    # read images
    img1 = cv2.imread("deer_orignal.jpg")
    img2 = cv2.imread("deer_temp.jpg")

    # Convert the colored image to gray image
    ...
    plot_two_images(img1=NCC_Matched_Image,img2=SSD_Matched_Image)
